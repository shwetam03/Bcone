...
$(document).ready(function () {
    ...
    setTimeout(function () {
        if (Counter == 0)  //Run the code on Page load 
        {
            ...
            var restSaveExternalHiring = "../_api/web/lists/getbytitle('RRF')/items?$Filter=Status eq 'Initiated External Hiring' and FPNAUserId eq '" + LoginUserID + "'&$Top=100000&$orderby=ID%20desc";
            $.ajax({
...
function showApprovalpopup(ResourceApprovalData) {
    ...
    _MailRMONO = resourceApprovalRRF[13];
...
function defer_refine_status(status, liname, PageLoad) {
    ...
    if (status == "allrecord") {
        ...
        url = "../_api/web/lists/getbytitle('RRF')/items?$select=NonApprovers,InternallyFulfilled,WorkLocation,NewProjectStartDate,NewProjectEndDate,ResourceProposedFlag,TATDateTime,SubmittedDate,CloneType,ProjectCode,RequirementPct,RRFCreatedDate,ProjectManagerUser/Title,NewAuthor/Title,FPNAUser/Title,ReportingToUser/Title,ClientPartnerUser/Title,RMOSPOCUser/Title,ResourceAgainstRRFInWD/EMail,Customer,GBU,EmployeeRole,NonBillableFlag,ProjectManagerUserId,FPNAUserId,ReportingToUserId,ClientPartnerUserId,RMOSPOCUserId,NewAuthorId,ID,ProjectName,LinkFilename,MinRelevantExp,IndustryExp,SecondarySkill,PrimarySkill,RoleBand,ProjectGUID,RRFNO,SubPractice,NewStartDate,NewEndDate,StartDate,EndDate,BaseLocation,RoleBand,Billability,Status&$Expand=ResourceAgainstRRFInWD,ProjectManagerUser,NewAuthor,FPNAUser,ReportingToUser,ClientPartnerUser,RMOSPOCUser&$Filter=Status eq 'Resource Selection' and ((NewAuthorId eq '" + LoginUserID + "') or (ReportingToUser eq '" + LoginUserID + "') or (ClientPartnerUser eq '" + LoginUserID + "') or (ProjectManagerUser eq '" + LoginUserID + "') or (FPNAUser eq '" + LoginUserID + "') or (RMOSPOCUser eq '" + LoginUserID + "'))&$Top=100000&$orderby=ID%20desc";
    }
        ...
        table_header = table_header + "<th style='width:'>Customer</th>"
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.d.results, function (key, value) {
                ...
                ResourceApprovalData = value.ID + "#" + value.ProjectGUID + "#" + value.EmployeeRole + "#" + value.Status + "#" + value.NonBillableFlag + "#" + value.GBU + "#" + value.EmployeeRole + "#" + value.ProjectManagerUserId + "#" + value.PendingWithId + "#" + value.NonApprovers + "#" + value.RMOSPOCUserId + "#" + value.ClientPartnerUserId + "#" + value.NewAuthorId + "#" + value.RRFNO;
                document.getElementById('rrfallrecordcount').innerHTML = allrecordCount;
                document.getElementById('rrfrmovalidationcount').innerHTML = rmovalidationCount;
                document.getElementById('rrfnonbillable').innerHTML = rrfnonbillable;
                document.getElementById('rrfresourceproposedcount').innerHTML = resourceproposedCount;
                ...
                if (status == "rrfnonbillable") {
                    ...
                    if (value.NonBillableFlag == null && LoginUserID == value.NewAuthorId) {
                    ...
                    if ((value.Status == "Draft" || value.Status == "RRF Saved") && value.NewAuthorId == LoginUserID) {
                        ...
                        if (value.NewAuthorId == LoginUserID) {
                            if (value.EmployeeRole != "Billable") {
                                ...
                                RRFLIHTML = RRFLIHTML + "<tr id=" + value.ID + "#" + value.ProjectGUID + "><td style='display:none;'></td><td width='10%'><div id='action'><i class='fa fa-info-circle' aria-hidden='true'></i><div class='action-view'><div class='tooltip-1'><span id='" + cmntID + "' class='glyphicon glyphicon-comment' aria-hidden='true' onclick='showCommentpopup(this)'></span><div class='tooltiptext-1'>Comment</div></div><div class='tooltip-1'><span id='" + rejId + "' class='fa fa-ban' aria-hidden='true' onclick='getWithdrawnComment(this)'></span><div class='tooltiptext-1' style='width:141px !important'>Withdrawn Comment</div></div><div class='tooltip-1'><span id='" + projRRFNo + '#;View' + "' class='glyphicon glyphicon-tag' aria-hidden='true' onclick='showViewlogPopup(this)'></span><div class='tooltiptext-1'>Log</div></div></div></div></td><td><a href='../SitePages/ResourceRequestForm.aspx?RRFNO=" + RRFNO + "' target='_blank' >" + RRFNO + "</a>" + clone + "</td><td>" + ProjectName + "" + ExternalInitated + "</td><td>" + Customer + "</td><td>" + StartDate + "</td><td>" + EndDate + "</td><td>" + Location + "</td><td>" + RoleBand + "</td><td>" + RRFStatus + "</td><td><td>" + value.NewAuthor.Title + "</td><div class='indication'><ul><li id='" + totalResourceId + "' title='Capacity'>" + TotalCount + "</li><li id='" + FreeResourceId + "' title='Availability'>" + FreeCount + "</li><li id='" + BookedResourceId + "' title='Roll Offs'>" + BookedCount + "</li><li onclick='refreshData(this)' title='Refresh'><i class='fa fa-refresh' aria-hidden='true'></i></li></ul></div></td></tr>"
                            }
                        }
                        else {
                            RRFLIHTML = RRFLIHTML + "<tr id=" + value.ID + "#" + value.ProjectGUID + "><td style='display:none;'></td><td width='10%'><div id='action'><i class='fa fa-info-circle' aria-hidden='true'></i><div class='action-view'><div class='tooltip-1'><span id='" + cmntID + "' class='glyphicon glyphicon-comment' aria-hidden='true' onclick='showCommentpopup(this)'></span><div class='tooltiptext-1'>Comment</div></div><div class='tooltip-1'><span id='" + rejId + "' class='fa fa-ban' aria-hidden='true' onclick='getWithdrawnComment(this)'></span><div class='tooltiptext-1' style='width:141px !important'>Withdrawn Comment</div></div><div class='tooltip-1'><span id='" + projRRFNo + '#;View' + "' class='glyphicon glyphicon-tag' aria-hidden='true' onclick='showViewlogPopup(this)'></span><div class='tooltiptext-1'>Log</div></div></div></div></td><td><a href='../SitePages/ResourceRequestForm.aspx?RRFNO=" + RRFNO + "' target='_blank' >" + RRFNO + "</a>" + clone + "</td><td>" + ProjectName + "" + ExternalInitated + "</td><td>" + Customer + "</td><td>" + StartDate + "</td><td>" + EndDate + "</td><td>" + Location + "</td><td>" + RoleBand + "</td><td>" + RRFStatus + "</td><td><td>" + value.NewAuthor.Title + "</td><div class='indication'><ul><li id='" + totalResourceId + "' title='Capacity'>" + TotalCount + "</li><li id='" + FreeResourceId + "' title='Availability'>" + FreeCount + "</li><li id='" + BookedResourceId + "' title='Roll Offs'>" + BookedCount + "</li><li onclick='refreshData(this)' title='Refresh'><i class='fa fa-refresh' aria-hidden='true'></i></li></ul></div></td></tr>"
                    ...
                    if ((value.Status == "Draft" || value.Status == "RRF Saved") && value.NewAuthorId == LoginUserID) {
                        ...
                        RRFLIHTML = RRFLIHTML + "<tr id=" + value.ID + "#" + value.ProjectGUID + "><td style='display:none;'></td><td width='10%'><div id='action'><i class='fa fa-info-circle' aria-hidden='true'></i><div class='action-view'><div class='tooltip-1'><span id='" + cmntID + "' class='glyphicon glyphicon-comment' aria-hidden='true' onclick='showCommentpopup(this)'></span><div class='tooltiptext-1'>Comment</div></div><div class='tooltip-1'><span id='" + ResourceData + "' class='glyphicon glyphicon-user' aria-hidden='true' onclick='showResourcepopup(this)'></span><div class='tooltiptext-1'>Resource</div></div><div class='tooltip-1'><span id='" + projRRFNo + '#;View' + "' class='glyphicon glyphicon-tag' aria-hidden='true' onclick='showViewlogPopup(this)'></span><div class='tooltiptext-1'>Log</div></div></div></div></td><td><a href='../SitePages/ResourceRequestForm.aspx?RRFNO=" + RRFNO + "' target='_blank' >" + RRFNO + "</a>" + clone + "</td><td>" + ProjectName + "" + ExternalInitated + "</td><td>" + Customer + "</td><td>" + StartDate + "</td><td>" + EndDate + "</td><td>" + Location + "</td><td>" + RoleBand + "</td><td>" + RRFCreatedDate + "</td><td>External Hiring</td><td>" + PendingWith + "</td></tr>"
                    }
                    else if (value.Status == "Resource Proposed" && (value.RMOSPOCUserId == LoginUserID || value.ProjectManagerUserId == LoginUserID)) {
                        var PendingWithTitle = "";
                        var ExternalLink = "";
...
function updateRRF(Flag) {
    ...
    if (pageStatus == "Withdrawn" || pageStatus == "Rejected") {
        if (RRFEmployeeRole.split('#')[0] != "Billable") {
    ...
    else if (RRFEmployeeRole.split('#')[0] != "Billable" && RRFEmployeeRole.split('#')[1] == "null" && pageStatus != "Functional Head") {
        getApproverNames(GBU, RRFRowID, LogProjectGUID, NonBillableApproverID);
        $.extend(item, { PendingWithId: NonBillableApproverID });
        ...
        var Cc = _MailNewAuthorId.toString() + ";" + NonApproversCC.toString() + ";" + "rmo@bcone.com";
        var EventId = "59";
        var Flag = "5";
        var TrackingId = _MailRMONO.toString();
        insertIntoSendEmailData(To, Cc, EventId, Flag, TrackingId);

    }
    else if ((RRFEmployeeRole.split('#')[1] == 1 || pageStatus == "Functional Head") && RRFEmployeeRole.split('#')[0] != "Billable") {
...
function RRFSaveResource(ResourceEmpID) {
    if (pageStatus == "RRF Saved" || pageStatus == "RMO Validation" || pageStatus == "Resource Proposed" || pageStatus == "Resource Selection" || pageStatus == "External Hiring" || pageStatus == "Offer") {
...
function SaveResourceassignment() {
    ...
    if (validateResourceAssignementData()) {
        ...
        var result = InserdataProjectwiseResourceallocation(projectCode, projectName, resourceName, resourceID, startDate, endDate, resourceAllocation, ProjectLoaction, resourceManager, projecManager, flagvalue, PrimarySkill, RRFNumber)
        if (result == "Inserted") {
    ...
    if (validateResourceAssignementData()) {
        ...
        if (no_checked.length > 0) {
            ...
            for (var index = 0; index < no_checked.length; index++) {
                ...
                var result = InserdataProjectwiseResourceallocation(ProjCode, ProjName, Employeename, EmployeeID, startDate, endDate, AllocationPerc, ProjectLoaction, RMOSPOCname, ProjManager, flagvalue, PrimarySkill, RRF_Number);
                if (result == "Inserted") {
                    count++;
                }
            }
...
function InserdataProjectwiseResourceallocation(projectCode, projectName, resourceName, resourceID, startDate, endDate, resourceAllocation, ProjectLoaction, RMOSPOCname, projecManager, flagvalue, PrimarySkill, RRF_Number) {
    var ResourceAllUrl = ProjectWiseAllocation();
    var result = "";
    var ActiveFlag = 1;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (RRFCount > 0) {
                ...
                else if ((dataset.ClientInterviewRequired == "" || dataset.ClientInterviewRequired == null) && dataset.RequirementType != "G&A") {
                ...
                else if (dataset.ReportingToUserId == "" || dataset.ReportingToUserId == null || dataset.ReportingToUserId == "Select" || dataset.ReportingToUserId == -1) {
